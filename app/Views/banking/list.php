            ...
            <div class="ui-card overflow-hidden flex flex-col justify-between">
                <div>
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        <p class="text-sm text-slate-600 leading-relaxed">Find your nearest Shree Bhagwant Multistate branch, get address, working hours, phone numbers, and directions on the map.</p>
                        <ul class="text-xs text-slate-500 space-y-1.5 pt-2">
