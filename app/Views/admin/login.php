...
<head>
    ...
    <title>Admin Login - Shree Bhagwant Multistate</title>
...
<body class="bg-brand-950 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 space-y-6">
        ...
        <div class="text-center space-y-2">
            ...
            <h1 class="text-2xl font-black text-slate-900 tracking-tight">Shree Bhagwant Admin Control</h1>
        ...
        <form action="<?= base_url('admin/login') ?>" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="email" name="email" required value="<?= old('email', 'admin@shreebhagwantmultistate.com') ?>" placeholder="admin@shreebhagwantmultistate.com" class="form-input text-xs">
            </div>
        ...
        <div class="bg-slate-50 p-3 rounded-lg border border-slate-200 text-center text-[11px] text-slate-500 space-y-0.5">
            ...
            <p>Email: <code class="bg-slate-200 px-1 py-0.5 rounded text-slate-800">admin@shreebhagwantmultistate.com</code></p>
