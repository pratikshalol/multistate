    ...
    <div class="bg-brand-900 text-slate-300 text-xs py-2 px-4">
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            <div class="flex items-center space-x-2 overflow-hidden">
                ...
                <?php else: ?>
                    <span>🏦 Samarth Multistate Co-operative Credit Society Ltd. — Trusted banking since inception.</span>
                <?php endif; ?>
            </div>
            <div class="hidden md:flex items-center divide-x divide-slate-700 text-[11px] shrink-0">
                ...
                <span class="pl-4">✉️ <?= esc($settings['contact_email'] ?? 'info@samarthmultistate.com') ?></span>
            </div>
        </div>
    </div>
                ...
                <a href="<?= base_url() ?>" class="flex items-center space-x-3 shrink-0">
                    ...
                    <?php else: ?>
                        ...
                        <div class="leading-tight">
                            <span class="font-black text-base tracking-tight text-brand-900 block">SAMARTH MULTISTATE</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-2 pb-3 border-b border-brand-800">
                        ...
                        <span class="font-bold text-white text-sm tracking-wide">Samarth Multistate</span>
                    </div>
