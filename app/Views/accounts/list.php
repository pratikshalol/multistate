    ...
    <div class="section-inner">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="ui-card overflow-hidden flex flex-col justify-between">
                ...
                <div class="p-6 pt-0">
                    <a href="<?= base_url('account-opening') ?>" class="block w-full text-center bg-brand-600 hover:bg-brand-700 text-white font-bold py-2.5 rounded-xl text-xs transition-colors">
                        Apply Now &rarr;
                    </a>
                </div>
            </div>
            ...
            <div class="ui-card overflow-hidden flex flex-col justify-between">
                ...
                <div class="p-6 pt-0">
                    <a href="<?= base_url('page/savings-account') ?>" class="block w-full text-center bg-brand-600 hover:bg-brand-700 text-white font-bold py-2.5 rounded-xl text-xs transition-colors">
                        Learn More &rarr;
                    </a>
                </div>
            </div>
            ...
            <div class="ui-card overflow-hidden flex flex-col justify-between">
                ...
                <div class="p-6 pt-0">
                    <a href="<?= base_url('page/current-account') ?>" class="block w-full text-center bg-brand-600 hover:bg-brand-700 text-white font-bold py-2.5 rounded-xl text-xs transition-colors">
                        Learn More &rarr;
                    </a>
                </div>
            </div>
